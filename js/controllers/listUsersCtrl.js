(function() {
    ...
    angular
        .module('myApp')
        .controller('listUsersCtrl', ['$scope', 'resolvedUsers', 'resolvedPosts', 'apiService', 'localStorageService', listUsersCtrl]);

    function listUsersCtrl($scope, resolvedUsers, resolvedPosts, apiService, localStorageService) {
        var self = this;
